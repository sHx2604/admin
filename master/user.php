<?php
// --- Koneksi ke database ---
$koneksi = new mysqli("localhost", "root", "", "prapto_bakmi");
...
if (isset($_POST['submit_baru'])) {
    ...
    $koneksi->query("INSERT INTO users (nama, username, password, role) VALUES ('$nama', '$username', '$password', '$role')");
...
if (isset($_POST['submit_edit'])) {
    ...
    $koneksi->query("UPDATE users SET nama='$nama', username='$username', password='$password', role='$role' WHERE id=$id");
           ...
           <?php if(!$edit_mode): ?>
            ...
            <form method="POST" action="">
              ...
              <?php endif; ?>
                ...
                <div class="mb-3">
                    <label>Nama</label>
                    <input type="text" name="nama" class="form-control" required value="<?= $edit_user['nama'] ?>">
                </div>
                <div class="mb-3">
                    <label>Username</label>
                ...
                <div class="mb-3">
                    ...
                    <input type="radio" name="role" value="Kasir" <?= $edit_user['role'] == 'Kasir' ? 'checked' : '' ?>> Kasir
                </div>
